...
let sessionId = localStorage.getItem("autonova_session") || null;
...
async function sendMessage(text) {
  ...
  try {
    ...
    localStorage.setItem("autonova_session", sessionId);
...
resetBtn.addEventListener("click", async () => {
  ...
  sessionId = null;
  localStorage.removeItem("autonova_session");
  messagesEl.innerHTML = "";
  agentBadge.textContent = "Ожидание маршрутизации";
  addMessage("bot", "Новый диалог. Я ИИ-оркестратор AutoNova — опишите ваш запрос.");
});
...
addMessage("bot", "Здравствуйте! Вы общаетесь с ИИ-системой AutoNova. Задайте вопрос — оркестратор направит к нужному агенту.");
